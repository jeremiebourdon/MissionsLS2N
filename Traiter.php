...
<form  action="TraitementTraiter.php" method="post">
  <ul style="list-style-type: none;">

    <li><label for="equipe">Equipe :</label><input list="listequipes" type="text" name="equipe" id="equipe"/><label for="mailequipe">Responsable : </label><input list="listmailequipes" type="text" name="mailequipe" id="mailequipe" readonly/></li>
    <li><label for="assistant">Assistante (mail) chargée du traitement de la demande :</label><input list="listassistant" type="text" name="assistant" id="assistant" readonly/></li>
...
<li>
  <li><label for="enseignement">Prévenir le département d'enseignement</label><select id="enseignement" name="enseignement">
      <option value="Aucun" selected>Non</option>
      <option value="Dpt-Info-Dir@univ-nantes.fr">Dpt Info : Faculté des sciences (Eric Montroy)</option>
    </select>
  </li>
  <li>A renseigner uniquement pour les voyages pris sur le marché Havas<br/>
    <ul>
    <li><label for="havasBC">Numéro de bon de commande </label>
    <input type="text" name="havasBC" id="havasBC"/></li>
    <li><label for="havasCC">Centre de coûts </label>
    <input type="text" name="havasCC" id="havasCC"/></li>
    </ul>
  </li>
    <li><input type="submit" value="Traiter la demande"/><label for="nomassistante"> Assistant(e) en charge de la mission :</label><input type="text" id="nomassistante" name="nomassistante"/></li>
